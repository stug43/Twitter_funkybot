...
def twitter_login(key1, key2, key3, key4)
...
def say_5_random_messages(array)
	
	def random_selection(array)
		selected_five = []
		while selected_five.uniq.size < 5
   	 selected_five << array[rand(array.size-1)]
   	 selected_five.uniq!
 		end
