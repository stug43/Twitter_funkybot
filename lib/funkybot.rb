...
def random_message(k)
	case k
		...
		when 1
			message = "Il y a deux mois, alors que j'étais en train de faire la vaisselle, je me suis soudainement mis à réfléchir aux raisons profondes qui nous poussent à avoir une préférence pour certaines couleurs plutôt que d'autres. Aussi, je vous charge de produire un article sur le sujet. Vous êtes génial !"
		when 0
